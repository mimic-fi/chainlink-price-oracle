 ...
 *      rely on the price oracle as well since these need to swap their earned rewards in order to reinvest them or
 *      calculate minimum amounts when entering or exiting instruments.
 */
